...
const ingr_prices:any = { //Need to make central type checking
    lettuce: 50, 
    cheese: 40,
    patty: 130,
    bacon: 70
...
const reducer = (state:any = initialState, action:any) => {
    switch (action.type){
        ...
        case actionTypes.SET_INGR: return setIngr(state, action);
        case actionTypes.FETCH_FAILIURE: return fetchFailiure(state, action);
        default:
        return state;
    }
}
